...
# PROBLEM- problem is that the code stops running because of a type error
...
def encryptMessage(message, cipherKey, alphabet):
    ...
    for currentCharacter in uppercaseMessage:
        ...
        newPosition = position + int(cipherKey) #<-- problem was here -before- newPosition = position + cipherKey
