...
#PROBLEM- Decryption is also Encrypted
...
def decryptMessage(message, cipherKey, alphabet):
    ...
    return encryptMessage(message, decryptKey, alphabet) #<--issue was here, wrong argument- before-encryptMessage(message, cipherKey, alphabet)
